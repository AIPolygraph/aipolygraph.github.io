...
function setupLangSwitcher() {
  ...
  if (uaLink) {uaLink.href = uaVersion; document.getElementById("lang-en").classList.add("active");}
  if (enLink) {enLink.href = enVersion; document.getElementById("lang-ua").classList.add("active");}
}
